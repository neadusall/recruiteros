  ...
  function connectedCatalog() {
    return [
      ...
      { id: "jd_sourcing", label: "JD Sourcing (RapidAPI people search)", status: "red", requiredFor: [],
        blurb: "Powers the JD Sourcing tab — people-search from a JD + profile lookup for deep-vetting. Bring your own RapidAPI account. Prefilled for the Linkedin Data Scraper API (API Builderz).",
        fields: [
          { key: "RAPIDAPI_KEY", label: "RapidAPI key", required: true, secret: true, placeholder: "paste your RapidAPI key", hint: "Your own RapidAPI account key (x-rapidapi-key)." },
          { key: "RAPIDAPI_PEOPLE_SEARCH_HOST", label: "Search · host", required: true, placeholder: "realtime-linkedin-fresh-data.p.rapidapi.com" },
          { key: "RAPIDAPI_PEOPLE_SEARCH_PATH", label: "Search · path", required: true, placeholder: "/search_people", hint: "Search People endpoint path." },
          { key: "RAPIDAPI_PEOPLE_SEARCH_METHOD", label: "Search · method", required: false, placeholder: "POST", hint: "GET or POST. POST for this listing." },
          { key: "RAPIDAPI_PROFILE_HOST", label: "Deep-vet · host", required: false, placeholder: "realtime-linkedin-fresh-data.p.rapidapi.com" },
          { key: "RAPIDAPI_PROFILE_PATH", label: "Deep-vet · path", required: false, placeholder: "/person_deep" },
          { key: "RAPIDAPI_PROFILE_METHOD", label: "Deep-vet · method", required: false, placeholder: "POST" },
          { key: "RAPIDAPI_PROFILE_BODY_KEY", label: "Deep-vet · URL field", required: false, placeholder: "link", hint: "POST only: body key for the URL (person_deep uses 'link')." }
        ],
        steps: ["Subscribe to the Linkedin Data Scraper API (API Builderz) — free Basic is enough to start.", "SEARCH → host: realtime-linkedin-fresh-data.p.rapidapi.com · path: /search_people · method: POST", "DEEP-VET → host: same · path: /person_deep · method: POST · URL field: link", "Paste your key, fill the values, Save."],
        docsUrl: "https://rapidapi.com/search/linkedin%20data%20scraper", docsLabel: "Linkedin Data Scraper API on RapidAPI ↗", present: [] },
