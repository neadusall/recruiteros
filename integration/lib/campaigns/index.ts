...
export const DEPLOY_PHASES = [
  { n: 1, title: "Infrastructure pre-flight", time: "one-time", done: "Overview capacity strip shows green",
    items: ["≥1 warmed LinkedIn account per motion", "≥5 warmed domains (15+ inbox capacity)", "RapidAPI job scraper enabled", "Enrichment waterfall (Fresh LinkedIn + Tomba)", "ATS connected", "OS Text + Telnyx 10DLC deployed"] },
  ...
  { n: 4, title: "Connect channels", time: "3 min", done: "All channels show ✓",
    items: ["Instantly campaign id", "LinkedIn account", "OS Text SMS toggle", "Loxo list id"] },
