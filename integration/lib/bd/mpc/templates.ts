...
export const MPC_TEMPLATES: MpcTemplate[] = [
  ...
  { id: "direct-5", angle: "Direct value", subject: "{your team's next {{Open_Role}}|a {{Open_Role}} fit for your team}",
  ...
  /* 2. Local market ------------------------------------------------------------------ */
  { id: "local-1", angle: "Local market", subject: "{local to you|right in your market}",
  ...
  { id: "local-2", angle: "Local market", subject: "{someone in your market|one from your market}",
  ...
  { id: "local-3", angle: "Local market", subject: "{your {{Open_Role}}, {{Near_City}}|a {{Open_Role}} out of {{Near_City}}}",
  ...
  { id: "local-4", angle: "Local market", subject: "{know your market, know this one|i know your market, and this one fits}",
  ...
  /* 3. Quiet candidate --------------------------------------------------------------- */
  { id: "quiet-1", angle: "Quiet candidate", subject: "{quiet one, worth a look|a quiet one worth a look}",
  ...
  { id: "quiet-2", angle: "Quiet candidate", subject: "{not on the market, {{First_Name}}|not openly looking, {{First_Name}}}",
  ...
  { id: "quiet-3", angle: "Quiet candidate", subject: "{before {{P_subj}} goes public|early look before {{P_subj}} goes public}",
  ...
  { id: "quiet-4", angle: "Quiet candidate", subject: "{a quiet maybe|a quiet maybe worth seeing}",
  ...
  /* 4. Not a mass email -------------------------------------------------------------- */
  { id: "solo-1", angle: "Not a mass email", subject: "{not a mass email, {{First_Name}}|just you on this one, {{First_Name}}}",
  ...
  { id: "solo-2", angle: "Not a mass email", subject: "{one specific person for one seat|one person, one seat}",
  ...
  { id: "solo-3", angle: "Not a mass email", subject: "{sending you one, not a list|one candidate, not a list}",
  ...
  { id: "solo-4", angle: "Not a mass email", subject: "{the reason i'm writing|why i'm writing you}",
  ...
  { id: "prox-1", angle: "Proximity", needsProximity: true, subject: "{right down the road|right up the road from you}",
  ...
  { id: "prox-2", angle: "Proximity", needsProximity: true, subject: "{one town over|a town over from you}",
  ...
  { id: "prox-3", angle: "Proximity", needsProximity: true, subject: "{in your backyard|basically your backyard}",
  ...
  { id: "prox-4", angle: "Proximity", needsProximity: true, subject: "{close to you|near you last week}",
  ...
  { id: "prox-5", angle: "Proximity", needsProximity: true, subject: "{already local|local already}",
  ...
  { id: "comp-1", angle: "Comparable placement", needsCompetitor: true, subject: "{placed one like this last week|just placed one like this}",
  ...
  { id: "comp-2", angle: "Comparable placement", needsCompetitor: true, subject: "{off a {{Competitor}} search|from a {{Competitor}} search}",
  ...
  { id: "comp-3", angle: "Comparable placement", needsCompetitor: true, subject: "{i place exactly this|this is the seat i place}",
  ...
  { id: "comp-4", angle: "Comparable placement", needsCompetitor: true, subject: "{your competitor just did this|{{Competitor}} just filled this seat}",
  ...
  { id: "comp-5", angle: "Comparable placement", needsCompetitor: true, subject: "{same seat, {{Near_City}}|same seat, over in {{Near_City}}}",
  ...
  /* 7. Ramp-ready -------------------------------------------------------------------- */
  { id: "ramp-1", angle: "Ramp ready", subject: "{no ramp needed|zero ramp on this one}",
  ...
  { id: "ramp-2", angle: "Ramp ready", subject: "{hits the ground running|producing from day one}",
  ...
  { id: "ramp-3", angle: "Ramp ready", subject: "{day one contributor|a day-one contributor}",
  ...
  { id: "ramp-4", angle: "Ramp ready", subject: "{already proven in the seat|proven in this exact seat}",
  ...
  /* 8. Matched to JD ----------------------------------------------------------------- */
  { id: "match-1", angle: "Matched to JD", subject: "{matched line by line|line-by-line match}",
  ...
  { id: "match-2", angle: "Matched to JD", subject: "{i think {{P_subj}} is your {{Open_Role}}|this is your {{Open_Role}}}",
  ...
  { id: "match-3", angle: "Matched to JD", subject: "{checks your two big boxes|your two big boxes, checked}",
  ...
  { id: "match-4", angle: "Matched to JD", subject: "{built for your {{Open_Role}}|built for your {{Open_Role}} seat}",
  ...
  /* 9. Help first -------------------------------------------------------------------- */
  { id: "help-1", angle: "Help first", subject: "{i can probably help|i think i can help}",
  ...
  { id: "help-2", angle: "Help first", subject: "{here if your {{Open_Role}} is a priority|if your {{Open_Role}} is a priority}",
  ...
  { id: "help-3", angle: "Help first", subject: "{one to save you the search|might save you a search}",
  ...
  { id: "help-4", angle: "Help first", subject: "{happy to point {{P_obj}} your way|glad to point {{P_obj}} your way}",
  ...
  /* 10. Timing / window -------------------------------------------------------------- */
  { id: "time-1", angle: "Timing", subject: "{before {{P_subj}} settles|before {{P_subj}} lands somewhere}",
  ...
  { id: "time-2", angle: "Timing", subject: "{short window on this one|the window's short on this one}",
  ...
  { id: "time-3", angle: "Timing", subject: "{taking calls this week|just started taking calls}",
  ...
  { id: "time-4", angle: "Timing", subject: "{mid process elsewhere|mid process with another firm}",
  ...
  { id: "cur-3", angle: "Curiosity", subject: "{probably should send this|figured i should send this}",
  ...
  { id: "cur-4", angle: "Curiosity", subject: "{worth 60 seconds|60 seconds, one candidate}",
  ...
  { id: "peer-1", angle: "Peer proof", subject: "{teams like yours are hiring this|teams at your stage keep hiring this}",
  ...
  { id: "peer-2", angle: "Peer proof", subject: "{pattern i keep seeing|a pattern i keep seeing}",
  ...
  { id: "peer-3", angle: "Peer proof", subject: "{same profile, three teams|third team needing this profile}",
