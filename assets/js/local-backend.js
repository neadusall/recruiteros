  ...
  function connectedCatalog() {
    return [
      ...
      { id: "telnyx", label: "Telnyx (calling engine)", status: "green", requiredFor: ["recruiting"],
        ...
        fields: [{ key: "TELNYX_API_KEY", label: "API key", required: true, secret: true, placeholder: "KEY01…" }, { key: "TELNYX_FROM_NUMBER", label: "Caller-ID number (E.164)", required: false, placeholder: "+13105551234", hint: "The number your voicemail drops call from." }],
        steps: ["In the Telnyx portal create an API key (Auth → API Keys → Create).", "Buy or port a phone number to dial from, and finish 10DLC brand + campaign registration so your calls connect.", "Paste the API key and your caller-ID number below, Save, then Test."],
