...
# Public URL (the subdomain Caddy serves OS Text on). Used for auth callbacks,
...
2) Once DNS resolves, Caddy gets the HTTPS cert automatically (apex + the OS Text subdomain).
